...
export class AppManager{
  ...
  constructor(){
    ...
    this.tadaSound = new Audio('https://github.com/Crisledezma/Proyecto-Final-JavaScript-Cenfotec/blob/main/assets/sound/tada.mp3');
    this.loseSound = new Audio('https://github.com/Crisledezma/Proyecto-Final-JavaScript-Cenfotec/blob/main/assets/sound/lose.mp3');
    this.winSound = new Audio('https://github.com/Crisledezma/Proyecto-Final-JavaScript-Cenfotec/blob/main/assets/sound/win.mp3');
  }
